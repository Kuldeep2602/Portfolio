  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 w-full max-w-5xl">
        ...
        <motion.div
          className="glass-bubble-card-glow lg:col-span-2 bg-blue-50/80 dark:bg-blue-900/20 backdrop-blur-xl border border-white/40 dark:border-white/10 shadow-xl dark:shadow-none rounded-3xl p-6 md:p-8 flex flex-col justify-between min-h-[300px] relative overflow-hidden group"
        ...
        <div className="flex flex-col gap-4">
          ...
          <Link to="/projects" className="flex-1">
            <motion.div
              className="glass-bubble-card bg-blue-50/80 dark:bg-blue-900/20 backdrop-blur-xl border border-white/40 dark:border-white/10 shadow-xl dark:shadow-none rounded-3xl p-5 h-full flex flex-col items-center justify-center text-center group relative overflow-hidden"
              variants={itemVariants}
            >
          ...
          {/* Contact Card */}
          <a href="https://cal.com/kuldeep-singh" target="_blank" rel="noopener noreferrer" className="flex-1">
            <motion.div
              className="glass-bubble-card bg-orange-50/80 dark:bg-orange-900/20 backdrop-blur-xl border border-white/40 dark:border-white/10 shadow-xl dark:shadow-none rounded-3xl p-5 h-full flex flex-col items-center justify-center text-center group relative overflow-hidden"
              variants={itemVariants}
            >
